...
REVISION_OPENWRT = 35400
REVISION_OPENWRT_FEEDS = 35400
REVISION_LUCI = 9663

INSTALL_PACKAGES = rsync luci avahi-dnsconfd mtd-utils mrd6 freeradius2 openssh-sftp-server tcpdump python pyserial libiwinfo picocom gw6c atftp libftdi
...
patch_target:
	cd backfire && for i in $$(ls $(PATCHES_TARGET_DIR)); do patch -p1 < $(PATCHES_TARGET_DIR)/$$i; done
